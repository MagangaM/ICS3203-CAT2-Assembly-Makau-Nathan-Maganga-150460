...
_start:
    ...
    xor eax, eax         ; Clear accumulator for result
    xor edx, edx         ; Clear auxiliary register
    mov ecx, input       ; Address of input buffer

parse_input:
    cmp byte [ecx], 0x0A ; Check for newline (end of input)
    je factorial_call    ; If newline, jump to factorial calculation
    cmp byte [ecx], 0    ; Check for null terminator (safety)
    je factorial_call
